...
async function renderChartJs(
  ...
  if (!chart.plugins) {
    if (version.startsWith('3') || version.startsWith('4')) {
      const chartDataLabelsV3 = require('chartjs-plugin-datalabels-v3');
      const chartAnnotationV3 = require('chartjs-plugin-annotation-v3');
      chart.plugins = [chartDataLabelsV3, chartAnnotationV3];
    } else {
